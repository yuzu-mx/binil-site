...
export default function LoginScreen() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-spots-bg px-8">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold mb-2">
          <span className="text-spots-accent">S</span>pots
        </h1>
        <p className="text-spots-muted text-sm leading-relaxed max-w-xs mx-auto">
      ...
      <p className="text-spots-muted text-xs mt-8 text-center">
